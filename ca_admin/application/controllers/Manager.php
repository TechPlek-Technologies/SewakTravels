...
class Manager extends BaseController
{
    ...
    function addNewTask()
    {
            ...
            $this->global['pageTitle'] = 'Add a Task';
    ...
    function editOldTask($taskId = NULL)
    {
            ...
            $this->global['pageTitle'] = 'Task Edit';
    ...
    {            
        ...
        else
        {
            ...
            if($result > 0)
            {
                ...
                $this->logrecord($process,$processFunction);
                $this->session->set_flashdata('success', 'Task Edit successful');
            }
            else
            {
                $this->session->set_flashdata('error', 'Task Edit failed');
            }
            redirect('tasks');
