...
<div class="row">
    ...
    <?php $this->load->helper("form"); ?>
     <form role="form" id="editNewAdvances" action="<?php echo base_url() ?>editNewAdvances" method="post" autocomplete="off">
                        ...
                        <div class="row">								                               
							...
							<div class="col-md-2">
                                <div class="form-group">
									...
									<select class="form-control form-control-sm required" id="rate" name="rate" required>
