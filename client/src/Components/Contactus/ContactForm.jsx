      ...
      <form onSubmit={(event)=>event.preventDefault()}>
        <div className="row">
          ...
          <div className="form-group col-lg-6">
            <input type="Number" className="form-control" id="review" placeholder="phone number" required={true} />
          </div>
          <div className="form-group col-lg-6">
            <input type="email" className="form-control" id="email" placeholder="email address" required={true} />
          </div>
          <div className="form-group col-md-12">
            <textarea className="form-control" type="text" placeholder="Write Your Message" id="exampleFormControlTextarea1" rows={6} required={true}></textarea>
          </div>
