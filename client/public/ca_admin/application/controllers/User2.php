...
class User extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //$this->isLoggedIn();
		$this->global['admin_details'] = $this->user_model2->adminCompanyListing();	
        $this->global['records'] = $this->user_model2->getHomePageList();
        // $this->global['offers'] = $this->offer_model->getOfferList();
        $this->datas();
    ...
    function checkEmailExists()
    {
        ...
        if(empty($userId)){
            $result = $this->user_model2->checkEmailExists($email);
        } else {
            $result = $this->user_model2->checkEmailExists($email, $userId);
        }
    ...
    function loadUserEdit()
    {
        ...
        $data['userInfo'] = $this->user_model2->getUserInfo($this->vendorId);
       ...
       // $this->form_validation->set_rules('cpassword2','Confirm Password','matches[cpassword]|max_length[20]');
        ...
        else
        {
            ...
            $userInfo = array();
                ...
                $userInfo['status'] = 1;
                $userInfo['updated_ip'] = $this->input->ip_address();
                $userInfo['updatedBy'] = $this->vendorId;
                $userInfo['updatedDtm'] = date('Y-m-d H:i:s');
           
                $result = $this->user_model2->editUser($userInfo, $this->vendorId);
                ...
                {
                    $this->session->set_flashdata('error', 'Account setting update failed.');
                }            
            redirect('userEdit');
        }
    }
    ...
    function changePassword()
    {
        ...
        else
        {
            ...
            $resultPas = $this->user_model2->matchOldPassword($this->vendorId, $oldPassword);
            ...
            else
            {
                ...
                $result = $this->user_model2->changePassword($this->vendorId, $usersData);
    ...
    function register_user()
    {
        ...
        //sms sent to 9990999876
            ...
            $checkExist = $this->user_model2->checkUserExist($mobile, $email);

            if ($checkExist == false) {

            $result = $this->user_model2->addNewUser($userInfo);
...
// 		$sendOtp = $this->sendSMS($mobile, $loginText, '');
    ...
    function getZipCode()
    {
        ...
        $data = $this->user_model2->getzipcodesearch($search);
    ...
    function add_to_cart()
    {
      ...
      // pre($this->input->post());
        $this->load->model('vehicle_model2');
        $data['minAmount'] = $this->vehicle_model2->getminamount();
    ...
    { 
        ...
        $result = $this->user_model2->checkMobileExist($mobile);
        ...
        if(!empty($result)){
            ...
            echo $result = $this->user_model2->addNewUser($userInfo);
        }
    }
    ...
    {		
        ...
        else
        {
			...
			$data['vehicleRecords'] = $this->vehicle_model2->getallvehicles();
			$data['vehicleRateRecords'] = $this->vehicle_model2->getvehiclesPrice($data['vehicleRecords'][0]->id, '', 'city', '');
    ...
    {		
        ...
        else
        {
			...
			$data['vehicleRecords'] = $this->vehicle_model2->getallvehicles();
			$data['vehicleRateRecords'] = $this->vehicle_model2->getvehiclesPrice($data['vehicleRecords'][0]->id, '', 'airport', '');
    ...
    function update_airport_cart()
    {
		...
		$data['vehicleRateRecords'] = $this->vehicle_model2->getvehiclesDetails($vehicle_id, $distance, 'city', '');
	...
	public function bookoutstationcar()
    {
        ...
        else
        {
			...
			$data['vehicleRecords'] = $this->vehicle_model2->getallvehicles();
			$data['vehicleRateRecords'] = $this->vehicle_model2->getvehiclesPrice($data['vehicleRecords'][0]->id, '', 'outstation', '');
	...
	function update_outstation_cart()
    {
		...
		$data['vehicleRateRecords'] = $this->vehicle_model2->getvehiclesDetails($vehicle_id, $distance, 'outstation', '');
	...
	public function bookrentalcar()
    {
        ...
        else
        {
			...
			$data['vehicleRecords'] = $this->vehicle_model2->getallvehicles();
			$data['vehicleRateRecords'] = $this->vehicle_model2->getvehiclesPrice($data['vehicleRecords'][0]->id, '', 'rental', $data['pick_type']);
			//echo '<br><br><br><br><br><br><br><br>';
			//pre($data['vehicleRateRecords']);
			//pre($data);
            $data['minAmount'] = $this->vehicle_model2->getminamount();
	...
	function update_rental_cart()
    {
		...
		$data['vehicleRateRecords'] = $this->vehicle_model2->getvehiclesDetails($vehicle_id, '', 'rental', $pick_type);
	...
	function quotation()
	{
		...
		$this->global['Description'] = "Are you looking for a safe and reliable Cab Service Provider. We offer Car & Coach Rental Services to individuals and corporate's in Gurugram, Delhi & NCR ";
		$this->loadViews("quotation", $this->global, null, null);
	}
