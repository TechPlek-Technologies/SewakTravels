...
<div class="card mb-3">
    ...
    <div class="card-body d-sm-flex justify-content-between">
        <h6 class="mb-sm-0">
            <a href="<?php echo base_url(); ?>partner">Partners's</a>
            <span>/</span>
...
<div class="row">
					<div class="col-md-8">
                        <form role="form" action="<?php echo base_url() ?>editPartnerData" method="post" id="editPartnerData" role="form">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            if(!empty($state))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $rl->state; ?>">
                                                        <?php echo $rl->state ?>
                                                    </option>
                                                    <?php
                                                }
