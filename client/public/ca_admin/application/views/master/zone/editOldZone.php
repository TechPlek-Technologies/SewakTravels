    ...
    <!--Card-->
        <div class="card">
	        ...
	        <div class="card-body">
                ...
                <form role="form" id="editZone" action="<?php echo base_url() ?>editZone" method="post" role="form">
                        <div class="row">
                        ...
                        <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm required" value="<?php echo $zone_name; ?>" id="zone_name" name="zone_name">
                                </div>
                                </div>
