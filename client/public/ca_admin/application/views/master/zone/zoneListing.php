                                ...
                                foreach ($vendorRecords as $record) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn-sm btn-outline-danger btn-rounded" href="<?php echo base_url() . 'deleteVendor/' . $record->id; ?>" data-toggle="tooltip" data-placement="bottom" title="Delete Vendor">
