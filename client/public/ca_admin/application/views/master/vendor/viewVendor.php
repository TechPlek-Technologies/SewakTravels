		...
		<div class="card mb-3">
			...
			<div class="card-body">
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-4">
							...
							<?php echo ucwords(strtolower($vendorRecords[0]->salutation . ' ' . $vendorRecords[0]->name)); ?>
						</div>
						<div class="col-md-4">
				...
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-4">
							<label class="font-weight-bold">ESI No.: </label>
							<?php echo $vendorRecords[0]->esi_no; ?>
						</div>
						<div class="col-md-4">
							<label class="font-weight-bold">PF No.: </label>
							<?php echo $vendorRecords[0]->pf_number; ?>
						</div>
						<!-- <div class="col-md-4">
							<label class="font-weight-bold">ESI Amount/mo: </label>
							<?php echo $vendorRecords[0]->esi_amount; ?>
						</div> -->
					</div>
				</div>
				<!-- <div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-4">
							<label class="font-weight-bold">PF Amount/mo: </label>
							<?php echo $vendorRecords[0]->pf_amount; ?>
						</div>
					</div>
				</div> -->
			</div>
					...
					<table width="100%" class="table table-striped table-bordered table-hover table-sm" id="dataTables-example">
						<thead>
							<tr>
								...
								<th>Police Verification Image</th>
								<th>GPS Rate</th>
								<th>Status</th>
								<th>Action</th>
							</tr>
							...
							if (!empty($vehicleRecords)) {
								...
								foreach ($vehicleRecords as $record) {
									...
									<tr>
										...
										<td><?php echo $record->alternate_mobile; ?></td>
										...
										<td>
											<?php if (!empty($record->driver_image)) { ?>
												<a href="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->driver_image; ?>" data-lightbox="roadtrip">
													<img src="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->driver_image; ?>" alt="ARCY Doc" class="img-fluid" />
												</a>
											<?php } ?>
										</td>
										<td>
											<?php if (!empty($record->aadhar_card_image)) { ?>
												<a href="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->aadhar_card_image; ?>" data-lightbox="roadtrip">
													<img src="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->aadhar_card_image; ?>" alt="ARCY Doc" class="img-fluid" />
												</a>
											<?php } ?>
										</td>
										<td>
											<?php if (!empty($record->driving_licence_image)) { ?>
												<a href="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->driving_licence_image; ?>" data-lightbox="roadtrip">
													<img src="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->driving_licence_image; ?>" alt="ARCY Doc" class="img-fluid" />
												</a>
											<?php } ?>
										</td>
										<td>
											<?php if (!empty($record->police_verification_image)) { ?>
												<a href="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->police_verification_image; ?>" data-lightbox="roadtrip">
													<img src="<?php echo base_url(); ?>upload/vehicle/images/<?php echo $record->police_verification_image; ?>" alt="ARCY Doc" class="img-fluid" />
												</a>
											<?php } ?>
										</td>
										...
										<i class="fas fa-eye"></i>
											...
											<a class="btn-sm btn-outline-primary btn-rounded" href="<?php echo base_url() . 'uploadVehicleLogo/' . $record->id; ?>" data-vehicle-id="<?= $record->id ?>" title="Upload Document" data-toggle="tooltip" data-placement="bottom" title="Upload Document">
										...
										<i class="fas fa-upload"></i>
											...
											<a class="btn-sm btn-outline-info btn-rounded" href="<?php echo base_url() . 'editOldVehicle/' . $record->id; ?>" title="Edit" data-toggle="tooltip" data-placement="bottom" title="Edit Vehicle">
												<i class="fas fa-pencil-alt"></i>
											</a>&nbsp;
											<a class="btn-sm btn-outline-danger btn-rounded deleteVehicle" href="#" data-id="<?php echo $record->id; ?>" title="Delete Vehicle" data-toggle="tooltip" data-placement="bottom" title="Delete Vehicle">
