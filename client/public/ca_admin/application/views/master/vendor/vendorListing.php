...
<div class="card mb-3">
  ...
  <div class="card-body d-sm-flex justify-content-between">
    ...
    <div class="col-md-6 text-right">
      <a class="btn btn-deep-purple btn-sm m-0" href="<?php echo base_url(); ?>addNewVendorLoan" data-toggle="tooltip" data-placement="bottom" title="Loan">
        <i class="fas fa-plus mr-1"></i> Loan
      </a>&nbsp;
      <a class="btn btn-info btn-sm m-0" href="<?php echo base_url(); ?>addNewVendorCharge" data-toggle="tooltip" data-placement="bottom" title="Vendor PF/ESI">
        <i class="fas fa-plus mr-1"></i> PF/ESI
      </a>&nbsp;
      <a class="btn btn-primary btn-sm m-0" href="<?php echo base_url(); ?>addNewVehicle" data-toggle="tooltip" data-placement="bottom" title="Add New Vehicle">
        <i class="fas fa-plus mr-1"></i> Vehicle
      </a>&nbsp;
      <a class="btn btn-unique btn-sm m-0" href="<?php echo base_url(); ?>vehicleTaxListings" data-toggle="tooltip" data-placement="bottom" title="Vehicle TAX Listings">
        <i class="fas fa-plus mr-1"></i> Vehicle MCD/TAX
      </a>&nbsp;
      <a class="btn btn-secondary btn-sm m-0" href="<?php echo base_url(); ?>addNewVendor" data-toggle="tooltip" data-placement="bottom" title="Add New Vendor">
        <i class="fas fa-plus mr-1"></i> Vendor
      </a>
    </div>
  </div>
</div>
