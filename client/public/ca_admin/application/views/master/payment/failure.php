                        ...
                        <div class="container">
                          <div class="row">
                            <div class="col-md-12 "style="background: #ffffff;padding:25px;text-align:center;">
							    <div class="wrap-all">
                                    <h4>The transaction has failed or was cancelled</h4>
                                    <h4>Please contact your bank or try again later. Here are the details:</h4>
                                    <div class="row ">
                                            ...
                                            <div class="cardesign mb-3">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-sm text-right"
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <th><strong>Transaction Status:</strong>
                                                                            </th>
                                                                            <td>Failed</td>
                                                                        </tr>
                                                                        <tr>
                                                ...
                                                <div class="card-footer p-2">
                                                    <a href="<?php echo base_url(); ?>"
                                                        class="btn btn-theme btn-theme-dark" title="Dashboard">Back</a>
                                                </div>
                                            </div>
