...
class BaseController extends CI_Controller {
	...
	function sendSMS($phone, $text, $dlrurl) 
	{
		$ApiUrl = SMS_URL;
		// $postdata = "Id=".SMS_USERNAME."&Pwd=".urlencode(SMS_PASSWORD)."&PhNo=".$phone."&text=".urlencode($text)."&SenderID=".SMS_SENDER_ID."&DlrUrl=".$dlrurl; 
		     
		$postdata = "Id=".SMS_USERNAME."&Pwd=".urlencode(SMS_PASSWORD)."&PhNo=".$phone."&text=".$text."&SenderID=".SMS_SENDER_ID."&TemplateID=".$dlrurl; 
